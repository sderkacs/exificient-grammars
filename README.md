...
> [!IMPORTANT]
>
> This is a modified version of the original project, which is a temporary solution for generating EXI grammars in the Go language for use with the [GO-EXI](http://github.com/sderkacs/go-exi) library. 
>
...
2. Grammars serialized to GoSourceCode (`class com.siemens.ct.exi.grammars.persistency.Grammars2GoSourceCode` *explorative*) intended for use with the [GO-EXI](http://github.com/sderkacs/go-exi) library.
