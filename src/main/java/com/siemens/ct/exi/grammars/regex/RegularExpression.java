...
//import org.apache.xerces.impl.xpath.regex.Op.ChildOp;
//import org.apache.xerces.impl.xpath.regex.Op.ConditionOp;
//import org.apache.xerces.impl.xpath.regex.Op.UnionOp;
//import org.apache.xerces.impl.xpath.regex.Token.ConditionToken;
//import org.apache.xerces.impl.xpath.regex.Token.FixedStringContainer;
//import org.apache.xerces.impl.xpath.regex.Token.ModifierToken;
 ...
 * <h4>Options</h4>
 * <p>
 * You can specify options to <a
 * href="#RegularExpression(java.lang.String, java.lang.String)">
 * <code>RegularExpression(</code><var>regex</var><code>, </code>
 * <var>options</var><code>)</code></a> or <a
 * href="#setPattern(java.lang.String, java.lang.String)">
 * <code>setPattern(</code><var>regex</var><code>, </code><var>options</var>
 * <code>)</code></a>. This <var>options</var> parameter consists of the
 ...
 * class="REGEX">[a,b]</kbd> matches <kbd>a</kbd> or <kbd>,</kbd> or
 ...
 * Regular Expression</a>. The <code>match()</code> method does not do subsring
 * matching but entire string matching.
 * 
 * </dl>
 * 
 * <hr width="50%">
 ...
 * <kbd>\Q</kbd>, <kbd>\N{</kbd><var>name</var><kbd>}</kbd>,
 ...
 * <kbd>(?[\p{ASSIGNED}]-[\p{M}\p{C}])?(?:\
 * p{M}|[\x{094D}\x{09CD}\x{0A4D}\x{0ACD}\x{
 * 0B3D}\x{0BCD}\x{0C4D}\x{0CCD}\x{0D4D}\x{0E3A}\x{0F84}]\p{L}|[\x{1160}-\x{11A7}]|[\x{11A8}-\x{11FF}]|[\x{FF9E}\x{FF9F}])
 * *</kbd>
 * 
 ...
 * + *
 * <dt class="REGEX">
 * <kbd>[</kbd><var>R<sub>1</sub></var><var>R<sub>2</sub></var>
 * <var>...</var><var>R<sub>n</sub></var><kbd>]</kbd> (without <a
 * href="#COMMA_OPTION">"," option</a>) + *
 * <dt class="REGEX">
 * <kbd>[</kbd><var>R<sub>1</sub></var><kbd>,</kbd><var>R<sub>2
 * </sub></var><kbd>,
 * </kbd><var>...</var><kbd>,</kbd><var>R<sub>n</sub></var><kbd>]</kbd> (with <a
 * href="#COMMA_OPTION">"," option</a>)
 ...
 * <kbd>\u005cx</kbd><var>HH</var>
 * <kbd>\u005cx{</kbd><var>HHHH</var><kbd>}</kbd> <!--kbd>\u005c
 * u</kbd><var>HHHH</var--> <kbd>\u005cv</kbd><var>HHHHHH</var>)
 * <p>
 * This range matches the character.
 * <li class="REGEX">
 * <var>C<sub>1</sub></var><kbd>-</kbd><var>C<sub>2</sub></var>
 * <p>
 * This range matches a character which has a code point that is >=
 * <var>C<sub>1</sub></var>'s code point and &lt;= <var>C<sub>2</sub></var>'s
 * code point. + *
 ...
 * <dt class="REGEX">
 * <kbd>[^</kbd><var>R<sub>1</sub></var><var>R<sub>2</sub></var
 * ><var>...</var><var>R<sub>n</sub></var><kbd>]</kbd> (without a <a
 * href="#COMMA_OPTION">"," option</a>)
 * <dt class="REGEX">
 * <kbd>[^</kbd><var>R<sub>1</sub></var><kbd>,</kbd><var>R<sub>
 * 2</sub></var><kbd>
 * ,</kbd><var>...</var><kbd>,</kbd><var>R<sub>n</sub></var><kbd>]</kbd> (with a
 ...
 * 
 * <dt class="REGEX">
 * <kbd>(?[</kbd><var>ranges</var><kbd>]</kbd><var>op</var><kbd
 * >[</kbd><var>ranges
 * </var><kbd>]</kbd><var>op</var><kbd>[</kbd><var>ranges</var><kbd>]</kbd> ...
 ...
 * 
 * <dt class="REGEX">
 * <kbd>[</kbd><var>R<sub>1</sub>R<sub>2</sub>...</var><kbd>-[<
 * /kbd><var>R<sub>n</sub>R<sub>n+1</sub>...</var><kbd>]]</kbd> (with an <a
 * href="#X_OPTION">"X" option</a>)</dt>
 ...
 * UnicodeData.txt</kbd></a>) or the specified <a
 ...
 * 
 * <dt class="REGEX">
 * <var>X</var><kbd>{</kbd><var>min</var><kbd>,</kbd><var>max</var><kbd>}</kbd>
 * <dd>...
 * 
 * <dt class="REGEX"><VAR>X</VAR><kbd>*?</kbd>
 * <dt class="REGEX"><VAR>X</VAR><kbd>+?</kbd>
 ...
 * 
 * <dt class="REGEX">
 * <kbd>(?</kbd><var>options</var><kbd>:</kbd><var>X</var><kbd>)</kbd>
 * <dt class="REGEX">
 * <kbd>(?</kbd><var>options</var><kbd>-</kbd><var>options2</var
 * ><kbd>:</kbd><var>X</var><kbd>)</kbd>
 * <dd>............................
 ...
 * <dt class="REGEX">
 * <kbd>(?</kbd><var>options</var><kbd>-</kbd><var>options2</var><kbd>)</kbd>
 * <dd>......
 ...
 * <dl>
 * <dt class="REGEX">
 * <kbd>(?(</Kbd><var>condition</var><Kbd>)</kbd><var>yes-pattern
 * </var><kbd>|</kbd><var>no-pattern</var><kbd>)</kbd>,
 * <dt class="REGEX">
 * <kbd>(?(</kbd><var>condition</var><kbd>)</kbd><var>yes-pattern
 * </var><kbd>)</kbd>
 * <dd>......
...
public class RegularExpression implements java.io.Serializable {
		...
		for (;;) {
			if (op == null || offset > con.limit || offset < con.start) {
				...
				case Op.CHAR: {
					...
					if (o1 >= con.limit
							|| o1 < 0
							|| !matchChar(op.getData(), target.charAt(o1),
									isSetIgnoreCase)) {
						returned = true;
						break;
					}
				...
				case Op.DOT: {
					...
					if (isSet(opts, SINGLE_LINE)) {
						if (REUtil.isHighSurrogate(target.charAt(o1))
								&& o1 + dx >= 0 && o1 + dx < con.limit) {
							o1 += dx;
						}
					} else {
						int ch = target.charAt(o1);
						if (REUtil.isHighSurrogate(ch) && o1 + dx >= 0
								&& o1 + dx < con.limit) {
							o1 += dx;
							ch = REUtil.composeFromSurrogates(ch,
									target.charAt(o1));
				...
				case Op.NRANGE: {
					...
					if (REUtil.isHighSurrogate(ch) && o1 + dx < con.limit
						...
						o1 += dx;
						ch = REUtil
								.composeFromSurrogates(ch, target.charAt(o1));
					}
				...
				case Op.STRING: {
					...
					if (dx > 0) {
						...
						if (!target.regionMatches(isSetIgnoreCase, offset
								- literallen, con.limit, literal, literallen)) {
							returned = true;
							break;
						}
						offset -= literallen;
				...
				case Op.NEGATIVELOOKBEHIND: {
					...
					dataStack.push(dx);
					dataStack.push(offset);
					dx = (op.type == Op.LOOKAHEAD || op.type == Op.NEGATIVELOOKAHEAD) ? 1
							: -1;
					op = op.getChild();
				}
					break;
	...
	boolean matchAnchor(ExpressionTarget target, Op op, Context con,
			int offset, int opts) {
		boolean go = false;
		switch (op.getData()) {
		case '^':
		...
		case '$':
			if (isSet(opts, MULTIPLE_LINES)) {
				...
				if (!(offset == con.limit || offset + 1 == con.limit
						&& isEOLChar(target.charAt(offset)) || offset + 2 == con.limit
		...
		case '<':
			...
			if (getWordType(target, con.start, con.limit, offset, opts) != WT_LETTER
					|| getPreviousWordType(target, con.start, con.limit,
							offset, opts) != WT_OTHER)
				return false;
			break;
	...
	static final class StringTarget extends ExpressionTarget {
		...
		final boolean regionMatches(boolean ignoreCase, int offset, int limit,
			...
			return (ignoreCase) ? target.regionMatches(true, offset, target,
					offset2, partlen) : target.regionMatches(offset, target,
					offset2, partlen);
		}
	}
	...
	static final class CharArrayTarget extends ExpressionTarget {
		...
		final boolean regionMatches(boolean ignoreCase, int offset, int limit,
			...
			return (ignoreCase) ? regionMatchesIgnoreCase(offset, limit,
					offset2, partlen) : regionMatches(offset, limit, offset2,
					partlen);
		}
	 ...
	 * class="REGEX"><kbd>(</kbd><var>X</var><kbd>)</kbd></span> captures
	 * matched text, and <span
	 * class="REGEX"><kbd>(:?</kbd><var>X</var><kbd>)</kbd></span> does not
	 * capture.
	 * 
	 ...
	 */
	static public final class IntStack {
