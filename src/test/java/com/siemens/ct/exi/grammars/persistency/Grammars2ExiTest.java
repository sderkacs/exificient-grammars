...
public class Grammars2ExiTest extends TestCase {
	...
	/**
	 * Implements SchemaIdResolver that resolves all of the time with the given
	 * GrammarsForGrammars instance.
	 */
	private static class GrammarsForGrammarsSchemaIdResolver implements
			SchemaIdResolver {
		private GrammarsForGrammars grammarsForGrammars;

		public GrammarsForGrammarsSchemaIdResolver(
				GrammarsForGrammars grammarsForGrammars) {
	...
	/**
	 * Get an EXIFactory with the grammars GrammarsForGrammars, coding mode
	 * COMPRESSION, using default encoding options, with INCLUDE_OPTIONS and
	 * INCLUDE_SCHEMA_ID.
	 * 
	 * @return
	...
	private static EXIFactory getExiFactory() throws UnsupportedOption {
		...
		exiFactory.setSchemaIdResolver(new GrammarsForGrammarsSchemaIdResolver(
				grammar));
		return exiFactory;
	}
	...
	protected void _test(String xsd, String xml) throws Exception {
		...
		ExiGrammars exiGrammar = g2j.toGrammarsX(grammarsIn);
		...
		InputSource exiInputSource = new InputSource(new ByteArrayInputStream(
				expecteds));
		...
		if (!(o instanceof ExiGrammars)) {
			throw new Exception("Unmarshalled object not of instance "
					+ ExiGrammars.class + ". Instead " + o.getClass());
		}
		ExiGrammars exiGrammars2 = (ExiGrammars) o;
		SchemaInformedGrammars grammarsOut = Grammars2X
				.toGrammars(exiGrammars2);
		// SchemaInformedGrammars grammarsOut = g2j.unmarshal(exiSource);
		// SchemaInformedGrammars grammarsOut = Grammars2Exi.unmarshal(new
	...
	public void test_notebook() throws Exception {
		_test("data/W3C/PrimerNotebook/notebook.xsd",
				"data/W3C/PrimerNotebook/notebook.xml");
	}

	@Test
	public void test_XMLSample() throws Exception {
		_test("data/W3C/XMLSample/XMLSample.xsd",
				"data/W3C/XMLSample/XMLSample.xml");
	}

	@Test
	public void test_EXIbyExample() throws Exception {
		_test("data/W3C/EXIbyExample/XMLSample.xsd",
				"data/W3C/EXIbyExample/XMLSample.xml");
	}
	...
	public void test_substitutionGroup1a() throws Exception {
		_test("./data/schema/substitutionGroup1.xsd",
				"./data/schema/substitutionGroup1a.xml");
	}

	@Test
	public void test_substitutionGroup1b() throws Exception {
		_test("./data/schema/substitutionGroup1.xsd",
				"./data/schema/substitutionGroup1b.xml");
	}

	@Test
	public void test_attributeGroup1a() throws Exception {
		_test("./data/schema/attributeGroup1.xsd",
				"./data/schema/attributeGroup1a.xml");
	}

	@Test
	public void test_attributeGroup1b() throws Exception {
		_test("./data/schema/attributeGroup1.xsd",
				"./data/schema/attributeGroup1b.xml");
	}

	@Test
	public void test_occurrences1() throws Exception {
		_test("./data/schema/occurrences1.xsd",
				"./data/schema/occurrences1.xml");
	}

	@Test
	public void test_occurrences2() throws Exception {
		_test("./data/schema/occurrences2.xsd",
				"./data/schema/occurrences2.xml");
	}
	...
	public void test_unsignedInteger() throws Exception {
		_test("./data/schema/unsignedInteger.xsd",
				"./data/schema/unsignedInteger.xml");
	}
	...
	public void test_anyAttributes() throws Exception {
		_test("./data/schema/anyAttributes.xsd",
				"./data/schema/anyAttributes.xml");
	}

	@Test
	public void test_globalAttribute1() throws Exception {
		_test("./data/schema/globalAttribute.xsd",
				"./data/schema/globalAttribute1.xml");
	}
	...
	public void test_attributeSpace() throws Exception {
		_test("./data/schema/attributeSpace.xsd",
				"./data/schema/attributeSpace.xml");
	}

	@Test
	public void test_identicalQName2() throws Exception {
		_test("./data/schema/identicalQName2.xsd",
				"./data/schema/identicalQName2.xml");
	}

	@Test
	public void test_identicalQName() throws Exception {
		_test("./data/schema/identicalQName.xsd",
				"./data/schema/identicalQName.xml");
	}

	@Test
	public void test_identicalQName3() throws Exception {
		_test("./data/schema/identicalQName3.xsd",
				"./data/schema/identicalQName3.xml");
	}

	@Test
	public void test_booleanPattern() throws Exception {
		_test("./data/schema/booleanPattern.xsd",
				"./data/schema/booleanPattern.xml");
	}
	...
	public void test_datatypeInteger() throws Exception {
		_test("./data/general/datatypeInteger.xsd",
				"./data/general/datatypeInteger.xml");
	}

	@Test
	public void test_datatypeFloat() throws Exception {
		_test("./data/general/datatypeFloat.xsd",
				"./data/general/datatypeFloat.xml");
	}
	...
	public void test_structure() throws Exception {
		_test("./data/general/complex-structure.xsd",
				"./data/general/complex-structure.xml");
	}

	@Test
	public void test_simpleContent() throws Exception {
		_test("./data/general/simpleContent.xsd",
				"./data/general/simpleContent.xml");
	}

	@Test
	public void test_emptyContent() throws Exception {
		_test("./data/general/emptyContent.xsd",
				"./data/general/emptyContent.xml");
	}
	...
	public void test_stringTable1() throws Exception {
		_test("./data/general/stringTable1.xsd",
				"./data/general/stringTable1.xml");
	}

	@Test
	public void test_stringTable2() throws Exception {
		_test("./data/general/stringTable2.xsd",
				"./data/general/stringTable2.xml");
	}
}
